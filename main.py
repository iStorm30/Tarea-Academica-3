...
def prepare_dataset():
    try:
        ...
        # Registra el error
        print(f"Error en prepare_dataset: {str(e)}")
        return "Error interno en la aplicación", 500
